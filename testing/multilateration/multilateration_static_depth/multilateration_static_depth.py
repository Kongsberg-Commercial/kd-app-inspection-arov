...
# Simulated Barometer Reading
# This is the static depth part. We currently use -6 meters, but this can be changed as needed
# For the most accurate position estimates, its important that the ROV is operating at this depth, but the overall logic should work no matter what depth the ROV is at.
def read_barometer():
    # In a real system, replace this with an actual barometer query (mavlink).
    return -6 
