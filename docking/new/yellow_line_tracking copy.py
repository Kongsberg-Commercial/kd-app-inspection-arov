...
and publishes to MQTT. Now includes HSV mask tuning sliders.
"""
...
def main():
    ...
    while True:
        ...
        # --- Line detection ---
        lines = cv.HoughLinesP(mask, 1, np.pi/180, threshold=60,
        ...
        if lines is not None:
            best_line = max(lines, key=lambda l: abs(l[0][1] - l[0][3]))
