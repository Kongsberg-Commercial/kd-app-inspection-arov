...
def main():
    ...
    while True:
        ...
        img = video.frame()
        if img is None:
            # For file playback: check for end of video
            if USE_FILE and video.cap.get(cv.CAP_PROP_POS_FRAMES) >= video.cap.get(cv.CAP_PROP_FRAME_COUNT):
        ...
        if lines is not None:
            ...
            # Pick the longest mostly vertical line
